...
public class CapabilityIdFiveOptions {
	@JsonProperty
	@NotNull
	...
	public CapabilityIdFiveOptions() {
		
	}


	public CapabilityIdFiveOptions(int capabilityId, int option1, int option2, int option3, int option4, int option5) {
		super();
