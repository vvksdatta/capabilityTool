...
public interface SkillDAO {
	...
	void insertSkillAssessment(@Bind("personId") int personId,@Bind("skillId") int skillId, @Bind("proficiency") String proficiency, @Bind("updatedBy") String updatedBy, @Bind("lastUpdate") Timestamp timeStamp);
	...
	List<ProgrammingSkillsDetailsComparisonGraphs> specificSkillOfPerson(@Bind("personId") int  personId, @Bind("skillId") int  skillId);
	...
	List<SkillTimelineGraphs> getDistinctProficienciesOfSkill(@Bind("personId") int  personId, @Bind("skillId") int  skillId);
