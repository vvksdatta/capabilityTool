...
//import se.bth.didd.wiptool.db.mapper.ProjectSummaryMapper;
...
public interface SprintDAO {
	...
	void updateSprintRequirementDescription(@Bind("sprintRequirementDescription") String sprintRequirementDescription, @Bind("sprintRequirementId") int sprintRequirementId );
	...
	void insertAssetsOfSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("assetId") int assetId );
	...
	void insertDomainsOfSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("domainId") int domainId );
	...
	List<SprintDevelopmentEnvironment> getDevelopmentEnvironmentsOfaSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId);
	
	@SqlQuery("select * from SprintQuestionnaire where projectId = :projectId and sprintId = :sprintId")
	List<SprintQuestionnaireTemplate> getSprintQuestionnaire (@Bind("projectId") int projectId, @Bind("sprintId") int sprintId );
	...
	void insertDevelopmentEnvInaSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("envId") int envId );
	...
	List<CompanyDrivenFactorsNames> getCompanyDrivenFactorsOfSprint (@Bind("projectId") int projectId, @Bind("sprintId") int sprintId);
	...
	List<SprintRequirementNameLevel> getRequirementsSelectedInSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId);
	...
	boolean ifPersonParticipatesInSprint(@Bind("projectId") int projectId, @Bind("personId") int personId, @Bind("sprintId") int sprintId );
	...
	void insertIntoSprintParticipation(@Bind("projectId") int projectId, @Bind("personId") int personId, @Bind("sprintId") int sprintId );
	...
	boolean ifDomainExistsInASprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("domainId") int domainId );
	
	@SqlQuery("select exists( select 1 from ASSETSINASPRINT where projectId= :projectId and sprintId = :sprintId and assetId = :assetId)")
	boolean ifAssetExistsInASprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("assetId") int assetId );
	...
	boolean ifRequirementSelected(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("sprintRequirementId") int sprintRequirementId );
	...
	void updateSprintParticipantExists(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("personId") int personId);
	...
	void updateSprintParticipantDoesnotExist(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("personId") int personId);
