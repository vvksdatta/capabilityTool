...
public interface PeopleDAO {
	...
	boolean ifCurrentPasswordExists(@Bind("userId") Integer userId, @Bind("userName") String userName, @Bind("password") String password);
	...
	// select TabA.issueId AS issues$issueId,TabA.projectId AS
	// projects$projectId, TabA.sprintId AS sprints$sprintId, TabB.personId AS
	// personId from SPRINTCOMPRISINGISSUES TabA JOIN ISSUES TabB USING(IssueId)
