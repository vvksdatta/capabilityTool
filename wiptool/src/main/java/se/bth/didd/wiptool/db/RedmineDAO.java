...
public interface RedmineDAO {
	...
	void insertIntoProjectParticipation(@Bind("projectId") int projectId, @Bind("personId") int personId, @Bind("roleId") int roleId );
	...
	void InsertIntoSprintParticipationTable(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("personId") int personId);
	...
	void InsertIntoSprintComprisingIssuesTable(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("issueId") int issueId);
	...
	void updateSprintProgress(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("sprintProgress") int sprintProgress);
	...
	void updateRedmineProjectIdentifier(@Bind("projectId") int projectId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier);
	...
	void updateRedmineProjectIdentifierInParticipationTable(@Bind("projectId") int projectId,@Bind("personId") int personId,@Bind("roleId") int roleId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier);
	...
	void updateIdentifiersInIssues(@Bind("projectId") int projectId, @Bind("issueId") int issueId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineIssueIdentifier") String redmineIssueIdentifier);
	...
	void updateIdentifiersInSprintComprisingIssues(@Bind("projectId") int projectId, @Bind("issueId") int issueId,  @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier,@Bind("redmineIssueIdentifier") String redmineIssueIdentifier );
	...
	void updateIdentifiersInSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintQuestionnaire(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintRequirement(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintAssets(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintDomains(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintparticipation(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId,@Bind("personId") int personId,  @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	...
	void updateIdentifiersInSprintDevEnvironments(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("redmineProjectIdentifier") String redmineProjectIdentifier, @Bind("redmineSprintIdentifier") String redmineSprintIdentifier);
	
	@SqlUpdate("update RolesOfPeople set status =:status where personId = :personId and roleId = :roleId ")
	void updateidentifierInRolesOfPeople(@Bind("personId") int personId, @Bind("roleId") int roleId, @Bind("status") String status);
	...
	void insertIntoPeopleTable(@Bind("personId") int personId, @Bind("personName") String personName, @Bind("firstName") String firstName, @Bind("lastName") String lastName, @Bind("emailId") String emailId, @Bind("status") String status);
	...
	void updatePeopleTable(@Bind("personId") int personId, @Bind("personName") String personName, @Bind("firstName") String firstName, @Bind("lastName") String lastName, @Bind("emailId") String emailId);
	
	//separate query as this identifier is updated each time the Redmine synchronization button is clicked
	...
	void updateProject(@Bind("projectId") int projectId,@Bind("parentProjectId") int parentProjectId, @Bind("projectName") String projectName,@Bind("projectDescription") String projectDescription, 
	...
	@SqlUpdate("update PROJECTS set  projectName = :projectName, projectDescription = :projectDescription, redmineLastUpdate = :redmineLastUpdate,"
			+ " projectLastUpdate = :projectLastUpdate  where projectId = :projectId")
	void updateProjectWithoutParentProject(@Bind("projectId") int projectId, @Bind("projectName") String projectName,@Bind("projectDescription") String projectDescription, 
			@Bind("redmineLastUpdate") Date redmineLastUpdate, @Bind("projectLastUpdate") Date projectLastUpdate);
	...
	boolean ifSprintDetailsUnModified(@Bind("projectId") int projectId,@Bind("sprintId") int sprintId, @Bind("sprintRedmineUpdate") Date sprintRedmineUpdate);
	...
	boolean ifPersonDetailsModified(@Bind("personId") int personId, @Bind("personName") String personName, @Bind("firstName") String firstName, @Bind("lastName") String lastName, @Bind("emailId") String emailId);
	
	
	@SqlQuery("select exists (select 1 from PROJECTS where projectId= :projectId and redmineLastUpdate = :redmineLastUpdate)")
	boolean ifProjectDetailsUnModified(@Bind("projectId") int projectId,@Bind("redmineLastUpdate") Date redmineLastUpdate );
	...
	boolean ifPersonParticipatesInProject(@Bind("projectId") int projectId, @Bind("personId") int personId, @Bind("roleId") int roleId );
	...
	boolean ifIssueExistsInSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("issueId") int issueId );
	...
	boolean ifIssueUnModified(@Bind("projectId") int projectId, @Bind("issueId") int issueId, @Bind("redmineLastUpdate") Date redmineLastUpdate );
	...
	boolean ifPersonParticipatesInSprint(@Bind("projectId") int projectId, @Bind("sprintId") int sprintId, @Bind("personId") int personId);
	...
	void deleteNonExistingProjectsFromParticipationTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 
	...
	void deleteNonExistingSprintsFromAssetsInSprintTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 
	
	@SqlUpdate("DELETE FROM REQUIREMENTSSELECTEDFORSPRINT  WHERE redmineSprintIdentifier NOT IN (:redmineSprintIdentifier)")
	void deleteNonExistingSprintsFromSprintRequirementsTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 
	
	@SqlUpdate("DELETE FROM SprintQuestionnaire  WHERE redmineSprintIdentifier NOT IN (:redmineSprintIdentifier)")
	void deleteNonExistingSprintsFromSprintQuestionnaireTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 

	@SqlUpdate("DELETE FROM SPRINTPARTICIPATION  WHERE redmineSprintIdentifier NOT IN (:redmineSprintIdentifier)")
	void deleteNonExistingSprintsFromSprintParticipationTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 
	...
	void deleteNonExistingSprintsFromSprintComprisingIssuesTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 

	@SqlUpdate("DELETE FROM DOMAINSINASPRINT WHERE redmineSprintIdentifier NOT IN (:redmineSprintIdentifier)")
	void deleteNonExistingSprintsFromDomainsInSprintTable (@Bind("redmineSprintIdentifier")  String redmineSprintIdentifier); 
	...
	void deleteNonExistingProjectsFromAssetsInSprintTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 
	
	@SqlUpdate("DELETE FROM REQUIREMENTSSELECTEDFORSPRINT  WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromSprintRequirementsTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 
	
	@SqlUpdate("DELETE FROM SprintQuestionnaire  WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromSprintQuestionnaireTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 

	@SqlUpdate("DELETE FROM SPRINTPARTICIPATION  WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromSprintParticipationTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 

	@SqlUpdate("DELETE FROM DEVELOPMENT_ENV_IN_A_SPRINT  WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromSprintDevEnvTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 

	@SqlUpdate("DELETE FROM SPRINTCOMPRISINGISSUES WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromSprintComprisingIssuesTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 

	@SqlUpdate("DELETE FROM DOMAINSINASPRINT WHERE redmineProjectIdentifier NOT IN (:redmineProjectIdentifier)")
	void deleteNonExistingProjectsFromDomainsInSprintTable (@Bind("redmineProjectIdentifier")  String redmineProjectIdentifier); 
	...
	void deleteNonExistingIssuesFromSprintComprisingIssuesTable (@Bind("redmineIssueIdentifier")  String redmineIssueIdentifier); 
